  ...
  tr: {
    translations: {
      ...
      initialConfig: {
        ...
        content2:
          "Bunu kolaylaştırmak için * Hayatın, otomatik bir başlangıç ​​konfigürasyonu sağlıyoruz, böylece tüm crmwhastapp * * İnanılmaz * özelliklerini birkaç dakika içinde test edebilirsiniz.",
        content3:
